 ...
 *
 * These components are exported from `@galyarder-framework/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@galyarder-framework/plugin-sdk/ui`
 */
