/**
 * `@galyarder-framework/plugin-sdk/ui` — Galyarder plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@galyarder-framework/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@galyarder-framework/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@galyarder-framework/plugin-sdk/ui";
 *
