  ...
  const packageJson = {
    ...
    ...(packedSharedTarball
      ? {
        pnpm: {
          overrides: {
            "@galyarder-framework/shared": `file:${toPosixPath(path.relative(outputDir, packedSharedTarball))}`,
          },
        },
      }
      : {}),
    devDependencies: {
      ...(packedSharedTarball
        ...
        : {}),
      "@galyarder-framework/plugin-sdk": sdkDependency,
...
import { createPluginBundlerPresets } from "@galyarder-framework/plugin-sdk/bundlers";
...
`,
  ...
  writeFile(
    ...
    `import { definePlugin, runWorker } from "@galyarder-framework/plugin-sdk";
...
`,
  ...
  writeFile(
    ...
    `import { usePluginAction, usePluginData, type PluginWidgetProps } from "@galyarder-framework/plugin-sdk/ui";
...
import { createTestHarness } from "@galyarder-framework/plugin-sdk/testing";
...
- \`pnpm build\` uses esbuild presets from \`@galyarder-framework/plugin-sdk/bundlers\`.
