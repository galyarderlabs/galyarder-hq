...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@galyarder-framework/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: GalyarderDashboardPluginManifestV1, pluginDbId?: string): void;
