...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@galyarder-framework/db";
import type {
  PluginStatus,
...
import type { ToolRunContext } from "@galyarder-framework/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@galyarder-framework/plugin-sdk";
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@galyarder-framework/plugin-hello-world-example",
  ...
  {
    packageName: "@galyarder-framework/plugin-file-browser-example",
  ...
  {
    packageName: "@galyarder-framework/plugin-kitchen-sink-example",
