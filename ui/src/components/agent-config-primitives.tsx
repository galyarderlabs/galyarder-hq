...
import { AGENT_ROLE_LABELS } from "@galyarder-framework/shared";
...
export const help: Record<string, string> = {
  ...
  workspaceStrategy: "How Paperclip Dashboard should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
