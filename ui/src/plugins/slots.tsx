 ...
 *
 * Plugin bundles are built with `external: ["@galyarder-framework/plugin-sdk/ui", "react", "react-dom"]`,
 * so their ESM output contains bare specifier imports like:
 *
 * ```js
 * import { usePluginData } from "@galyarder-framework/plugin-sdk/ui";
 ...
 * - `import { ... } from "@galyarder-framework/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@galyarder-framework/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@galyarder-framework/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@galyarder-framework/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@galyarder-framework/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@galyarder-framework/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
