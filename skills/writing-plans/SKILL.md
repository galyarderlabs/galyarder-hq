...
**Save plans to:** `docs/galyarder-framework/plans/YYYY-MM-DD-<feature-name>.md`
...
**"Plan complete and saved to `docs/galyarder-framework/plans/<filename>.md`. Two execution options:**
